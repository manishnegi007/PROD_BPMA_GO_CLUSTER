...
public class MliBotController{
	...
	public Map<String, Map<String,String>> APICallSSOValidation(String ssoId, String password, String sessionId)
	{
		...
		try 
		{
			...
			requestdata.append("	            \"soaCorrelationId\": \"lRQnxREBEz\",	");
			requestdata.append("	            \"soaMsgVersion\": \"1.0\",	");
			requestdata.append("	            \"soaAppId\": \"TRA\",	");
			requestdata.append("	            \"soaUserId\": \"TRA123\",	");
			requestdata.append("	            \"soaPassword\": \"dHJhMTIz\"	");
			requestdata.append("	        },	");
