...
public class NbAchievement 
{
	public static String achievementIntent(String channel,String period, String userzone,String user_region,String real_tim_timstamp,
			...
			String ytd_paid_case_pln, String user_circle, String subchannel, String user_clusters, String user_go)
	{
			...
			&& "".equalsIgnoreCase(user_clusters) && "".equalsIgnoreCase(period))
		{
			...
			&& !"".equalsIgnoreCase(user_clusters) && "".equalsIgnoreCase(period))
		{
			finalresponse="At MTD level "+user_clusters+" has achieved "+achiev_mtd_adj_mfyp+" % of Management Plan for Adj MFYP & "+achiev_mtd_paid_case+" % of Paid Cases, Monthly plan for Adj MFYP is "+mtd_adj_afyp_act+
			...
			&& !"".equalsIgnoreCase(user_clusters) && !"".equalsIgnoreCase(period))
		{
			...
			{
				finalresponse="At YTD level "+user_clusters+" has achieved "+achiev_ytd_adj_mfyp+" % of Management Plan for Adj MFYP & "+achiev_ytd_paid_case+" % of Paid Cases, Monthly plan for Adj MFYP is "+ytd_adj_mfyp_pln+
						" till "+real_tim_timstamp+" We have achieved "+ytd_adj_mfyp_act+" Cr & "+ytd_paid_case_act+" paid cases against "+ytd_paid_case_pln+
						"";	
			}
		}
